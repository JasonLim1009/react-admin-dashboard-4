          ...
          <div className="offer__list">
            <div className="offer__item">
              <div className="box__01">
                <h3 className="client__name">Jason Lim</h3>
                <h6 className="avg__price">
                  $16,500
                  <span>average price</span>
                </h6>
                <h6 className="market__price">Market average is $15,800</h6>
              ...
              <div className="box__03">
                ...
                <h6 className="spend__amount">$1274</h6>
              ...
              <div className="box__05">
                ...
                <h6 className="spend__amount">$851</h6>
                <p className="spend__title">Spend Per Unit Turned</p>
              </div>
            </div>
            <div className="offer__item">
              <div className="box__01">
                <h3 className="client__name">Aida</h3>
                <h6 className="avg__price">
                  $14,102 <span>average price</span>
                </h6>

                <h6 className="market__price">Market average is $13,458</h6>
                <span className="arrow__key">
                  <i class="ri-arrow-right-fill"></i>
                </span>
              </div>
              ...
              <div className="box__03">
                ...
                <h6 className="spend__amount">$1074</h6>
                <p className="spend__title">Model Spend</p>
              </div>
              ...
              <div className="box__05">
                ...
                <h6 className="spend__amount">$742</h6>
                <p className="spend__title">Spend Per Unit Turned</p>
              </div>
            </div>
          </div>
